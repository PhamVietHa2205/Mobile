...
Product minByPrice(List<Product> listProduct) {
  Product minPriceProduct = listProduct[0];
...
void main() {
  ...
  Product minPriceProduct = minByPrice(listProduct);
    print(minPriceProduct.toString());
}
